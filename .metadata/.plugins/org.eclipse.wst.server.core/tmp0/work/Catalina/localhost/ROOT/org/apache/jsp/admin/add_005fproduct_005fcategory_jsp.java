 ...
 * Generated at: 2023-12-28 11:06:08 UTC
...
public final class add_005fproduct_005fcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/css/admin/add_product_category.css?v=1.2\" />\r\n");
      ...
      out.write("				<div id=\"md\">\r\n");
      out.write("					<div id=\"mt\">\r\n");
      out.write("						<div id=\"mtd\">상품 추가 1/3단계 - 카테고리 설정</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div id=\"formDiv\">\r\n");
      out.write("						<form action=\"/admin/addProduct.do\"\r\n");
      out.write("							onsubmit=\"validateForm(this, event)\" id=\"form\">\r\n");
      out.write("							<div id=\"iDiv1\">\r\n");
      out.write("								<label for=\"cn\">카테고리</label> <select id=\"cn\"\r\n");
      out.write("									onchange=\"changeSubCategories()\">\r\n");
      out.write("									<option>top</option>\r\n");
      out.write("									<option>bottom</option>\r\n");
      out.write("									<option>outer</option>\r\n");
      out.write("									<option>shoes</option>\r\n");
      out.write("									<option>etc</option>\r\n");
      out.write("								</select>\r\n");
      out.write("							</div>\r\n");
      out.write("							<div id=\"iDiv2\">\r\n");
      out.write("								<label for=\"scn\">세부 카테고리</label><select name=\"sub_category_num\"\r\n");
      out.write("									id=\"scn\">\r\n");
      out.write("									<option value=\"1\">longSleeve</option>\r\n");
      out.write("									<option value=\"2\">shortSleeve</option>\r\n");
      out.write("									<option value=\"3\">hoodie</option>\r\n");
      out.write("									<option value=\"4\">zip</option>\r\n");
      out.write("									<option value=\"5\">collar</option>\r\n");
      out.write("								</select>\r\n");
      out.write("							</div>\r\n");
      out.write("							<div id=\"iDiv3\">\r\n");
      out.write("								<button type=\"submit\">기본 설정 이동</button>\r\n");
      out.write("							</div>\r\n");
      out.write("						</form>\r\n");
      out.write("					</div>\r\n");
      out.write("				</div>\r\n");
      ...
      out.write("		function changeSubCategories() {\r\n");
      out.write("			var categorySelect = document.getElementById('cn');\r\n");
      out.write("			var subcategorySelect = document.getElementById('scn');\r\n");
      out.write("\r\n");
      out.write("			// Clear existing options\r\n");
      out.write("			subcategorySelect.innerHTML = '';\r\n");
      out.write("\r\n");
      out.write("			// Get the selected category\r\n");
      out.write("			var selectedCategory = categorySelect.value;\r\n");
      out.write("\r\n");
      out.write("			// Populate subcategories based on the selected category\r\n");
      out.write("			if (selectedCategory === 'top') {\r\n");
      out.write("				addOption(subcategorySelect, '1', 'longSleeve');\r\n");
      out.write("				addOption(subcategorySelect, '2', 'shortSleeve');\r\n");
      out.write("				addOption(subcategorySelect, '3', 'hoodie');\r\n");
      out.write("				addOption(subcategorySelect, '4', 'zip');\r\n");
      out.write("				addOption(subcategorySelect, '5', 'collar');\r\n");
      out.write("			} else if (selectedCategory === 'bottom') {\r\n");
      out.write("				addOption(subcategorySelect, '6', 'denim');\r\n");
      out.write("				addOption(subcategorySelect, '7', 'training');\r\n");
      out.write("				addOption(subcategorySelect, '8', 'wide');\r\n");
      out.write("				addOption(subcategorySelect, '9', 'short');\r\n");
      out.write("				addOption(subcategorySelect, '10', 'cotton');\r\n");
      out.write("			} else if (selectedCategory === 'outer') {\r\n");
      out.write("				addOption(subcategorySelect, '11', 'jackets');\r\n");
      out.write("				addOption(subcategorySelect, '12', 'coats');\r\n");
      out.write("				addOption(subcategorySelect, '13', 'vests');\r\n");
      out.write("				addOption(subcategorySelect, '14', 'parkas');\r\n");
      out.write("				addOption(subcategorySelect, '15', 'blazers');\r\n");
      out.write("			} else if (selectedCategory === 'shoes') {\r\n");
      out.write("				addOption(subcategorySelect, '16', 'sneakers');\r\n");
      out.write("				addOption(subcategorySelect, '17', 'boots');\r\n");
      out.write("				addOption(subcategorySelect, '18', 'sandals');\r\n");
      out.write("				addOption(subcategorySelect, '19', 'Slippers');\r\n");
      out.write("				addOption(subcategorySelect, '20', 'loafers');\r\n");
      out.write("			} else if (selectedCategory === 'etc') {\r\n");
      out.write("				addOption(subcategorySelect, '21', 'hats');\r\n");
      out.write("				addOption(subcategorySelect, '22', 'belts');\r\n");
      out.write("				addOption(subcategorySelect, '23', 'Sunglasses');\r\n");
      out.write("				addOption(subcategorySelect, '24', 'gloves');\r\n");
      out.write("				addOption(subcategorySelect, '25', 'accessories');\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("\r\n");
